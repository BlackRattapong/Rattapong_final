  ...
  render() {
    ...
    if (localStorage.getItem('user') !== null) {
      fbContent = (
        ...
        >
          <img src={JSON.parse(localStorage.getItem('user')).picture.data.url} alt={this.state.name} />
          <h2>ยินดีต้อนรับ {JSON.parse(localStorage.getItem('user')).name}</h2>
